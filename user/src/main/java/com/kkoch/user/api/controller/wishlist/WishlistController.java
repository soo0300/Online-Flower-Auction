...
import com.kkoch.user.api.controller.wishlist.request.RemoveWishlistRequest;
...
public class WishlistController {
    ...
    @DeleteMapping()
    public ApiResponse<?> removeWishlist(@RequestBody RemoveWishlistRequest request) {
        return ApiResponse.of(MOVED_PERMANENTLY, null, null);
    }
}
