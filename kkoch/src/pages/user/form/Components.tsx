...
import flowerBackImg from "@/assets/flowerBackImg.png";
...
export const Overlay = styled.div`
  background: #ff416c;
  background: -webkit-linear-gradient(to right, #F8F4EB, #F8F4EB);
  background: linear-gradient(to right, #F8F4EB, #F8F4EB);
...
export const OverlayPanel = styled.div`
  ...
  transform: translateX(0);
  transition: transform 0.6s ease-in-out;
  background-image: url('${flowerBackImg}');
  background-size: 50%;
